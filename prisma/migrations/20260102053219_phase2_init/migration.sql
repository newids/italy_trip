...
CREATE TABLE "Highlight" (
    ...
    CONSTRAINT "Highlight_dayId_fkey" FOREIGN KEY ("dayId") REFERENCES "Day" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Accommodation" (
    ...
    "link" TEXT,
    "note" TEXT,
    CONSTRAINT "Accommodation_dayId_fkey" FOREIGN KEY ("dayId") REFERENCES "Day" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
